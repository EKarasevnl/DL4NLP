...
#SBATCH --gpus=1
#SBATCH --job-name=flores_int4
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=16
#SBATCH --time=08:00:00
#SBATCH --output=outputs/flores_eval/flores_int4_%A.out
#SBATCH --mem=128G
...
python flores_eval_parallel.py   --dataset_path "$DATASET_DIR"   --langs deu_Latn,rus_Cyrl,fra_Latn,nld_Latn,pol_Latn,lvs_Latn,zul_Latn,tel_Telu,swh_Latn   --mode int4   --directions both   --split devtest   --batch_size 8   --max_new_tokens 256   --output_dir outputs/flores_eval

echo "Done. Scores written to outputs/flores_eval/flores_scores_int4.csv"
