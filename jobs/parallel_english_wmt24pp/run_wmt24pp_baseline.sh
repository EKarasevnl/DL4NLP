...
#SBATCH --gpus=1
#SBATCH --job-name=wmt24pp_baseline
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=16
#SBATCH --time=08:00:00
#SBATCH --output=outputs/wmt24pp_eval/wmt24pp_baseline_%A.out
#SBATCH --mem=128G
...
python wmt24pp_eval_parallel.py   --dataset /home/scur1832/DL4NLP/data/wmt24pp   --langs deu_Latn,rus_Cyrl,fra_Latn,nld_Latn,pol_Latn,lvs_Latn,zul_Latn,tel_Telu,swh_Latn   --mode baseline   --directions both   --batch_size 8   --max_new_tokens 256   --output_dir outputs/wmt24pp_eval

echo "Done. Scores written to outputs/wmt24pp_eval/wmt24pp_scores_baseline.csv"
