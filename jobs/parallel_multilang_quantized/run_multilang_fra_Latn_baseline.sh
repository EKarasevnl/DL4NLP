...
#SBATCH --gpus=1
#SBATCH --job-name=multilang_fra_baseline
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=16
#SBATCH --time=08:00:00
#SBATCH --output=outputs/multilang_eval/multilang_fra_Latn_baseline_%A.out
#SBATCH --mem=128G
...
echo "Starting multilingual evaluation for source language: fra_Latn, mode: baseline"
...
echo "Done. Scores written to outputs/multilang_eval/multilang_scores_fra_Latn_baseline.csv"
