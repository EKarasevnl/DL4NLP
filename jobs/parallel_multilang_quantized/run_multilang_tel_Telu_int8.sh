...
#SBATCH --gpus=1
#SBATCH --job-name=multilang_tel_int8
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=16
#SBATCH --time=08:00:00
#SBATCH --output=outputs/multilang_eval/multilang_tel_Telu_int8_%A.out
#SBATCH --mem=128G
...
echo "Starting multilingual evaluation for source language: tel_Telu, mode: int8"
...
echo "Done. Scores written to outputs/multilang_eval/multilang_scores_tel_Telu_int8.csv"
