...
#SBATCH --gpus=1
#SBATCH --job-name=multilang_rus_baseline
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=16
#SBATCH --time=08:00:00
#SBATCH --output=outputs/multilang_eval/multilang_rus_Cyrl_baseline_%A.out
#SBATCH --mem=128G
...
echo "Starting multilingual evaluation for source language: rus_Cyrl, mode: baseline"
...
echo "Done. Scores written to outputs/multilang_eval/multilang_scores_rus_Cyrl_baseline.csv"
