...
#SBATCH --gpus=1
#SBATCH --job-name=multilang_rus_int4
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=16
#SBATCH --time=08:00:00
#SBATCH --output=outputs/multilang_eval/multilang_rus_Cyrl_int4_%A.out
#SBATCH --mem=128G
...
echo "Starting multilingual evaluation for source language: rus_Cyrl, mode: int4"
...
echo "Done. Scores written to outputs/multilang_eval/multilang_scores_rus_Cyrl_int4.csv"
