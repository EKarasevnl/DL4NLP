...
#SBATCH --gpus=1
#SBATCH --job-name=multilang_nld_int8
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=16
#SBATCH --time=08:00:00
#SBATCH --output=outputs/multilang_eval/multilang_nld_Latn_int8_%A.out
#SBATCH --mem=128G
...
echo "Starting multilingual evaluation for source language: nld_Latn, mode: int8"
...
echo "Done. Scores written to outputs/multilang_eval/multilang_scores_nld_Latn_int8.csv"
